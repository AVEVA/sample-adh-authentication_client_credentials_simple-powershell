...
$DiscoveryUrlRequest = Invoke-WebRequest -Uri ($Resource + "/identity/.well-known/openid-configuration") -Method Get
...
$TokenRequest = Invoke-WebRequest -Uri $TokenUrl -Body $TokenForm -Method Post -ContentType "application/x-www-form-urlencoded"
...
$TenantRequest = Invoke-WebRequest -Uri ($Resource + "/api/" + $ApiVersion + "/Tenants/" + $TenantId) -Method Get -Headers $AuthHeader
